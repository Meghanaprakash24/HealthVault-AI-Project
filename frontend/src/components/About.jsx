      ...
      <div className="relative z-10 max-w-3xl w-full bg-white/20 backdrop-blur-lg rounded-3xl shadow-2xl p-10 flex flex-col items-center border border-white/30 animate-fade-in-up">
        ...
        <div className="w-full flex flex-col items-center mt-4 animate-fade-in-up">
          ...
          <div className="flex gap-6">
            <a href="meghanaprakash2004@gmail.com" className="bg-gradient-to-r from-blue-500 to-purple-500 text-white px-6 py-2 rounded-full font-semibold shadow-lg hover:scale-105 transition-all duration-300 animate-pulse">Email Us</a>
            <a href="https://www.linkedin.com/in/meghana-prakash-094814258/" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-teal-500 to-blue-500 text-white px-6 py-2 rounded-full font-semibold shadow-lg hover:scale-105 transition-all duration-300 animate-pulse">LinkedIn</a>
          </div>
        </div>
      </div>
    </div>
